...
const Home = () => {
  ...
  const data = [
    { i: 'i', x: 0, y: 0, w: 2, h: 2, embedUrl: 'https://public.tableau.com/views/SiempreCRM/SIEMPRECRM?:display_count=y&:origin=viz_share_link', posterUrl: 'https://public.tableau.com/static/images/Si/SiempreCRM/SIEMPRECRM/4_3.png' },
    { i: 'a', x: 1, y: 0, w: 1, h: 1, embedUrl: 'https://public.tableau.com/views/VGContest_SummerNewsRecap_CoreyJones/Main?:embed=y&:loadOrderID=0&:display_count=y&publish=yes&:origin=viz_share_link', posterUrl: 'https://cdns.tblsft.com/sites/default/files/styles/viz_gallery_thumb/public/visualizations/2016_summer_news_recap_corey_jones_480x268_1.png?itok=qpHhpdJW' },
    { i: 'b', x: 2, y: 0, w: 1, h: 1, embedUrl: 'https://public.tableau.com/views/AustinTeacherTurnoverstory_10_0/TeacherTurnoverinAustin?:embed=y&:loadOrderID=0&:display_count=y&:origin=viz_share_link', posterUrl: 'https://cdns.tblsft.com/sites/default/files/styles/viz_gallery_thumb/public/visualizations/vg_austin_teacher_turnover_wide.png?itok=TM4OIjWZ' },
    { i: 'c', x: 3, y: 0, w: 1, h: 1, embedUrl: 'https://public.tableau.com/views/RiskofLoanDefault/Risk?:embed=y&:loadOrderID=0&:display_count=y&:origin=viz_share_link', posterUrl: 'https://cdns.tblsft.com/sites/default/files/styles/viz_gallery_thumb/public/visualizations/vg_loan_risk_anaylsis_wide.png?itok=LI60yskB' },
    ...
    { i: 'g', x: 3, y: 1, w: 1, h: 1, embedUrl: 'https://public.tableau.com/views/VGContest_AAPLTicker_YuriFal/AAPL?:embed=y&:loadOrderID=0&:display_count=y&publish=yes&:origin=viz_share_link', posterUrl: 'https://cdnl.tblsft.com/sites/default/files/styles/viz_gallery_thumb/public/visualizations/pediatrics_overview_bridget_cogley_480x268.png?itok=qi-ilh95' },
    { i: 'h', x: 2, y: 2, w: 1, h: 1, embedUrl: 'https://public.tableau.com/views/Dashboard-Publico-Educatic/Obesity?:display_count=y&:origin=viz_share_link', posterUrl: 'https://public.tableau.com/static/images/Da/Dashboard-Publico-Educatic/Obesity/4_3.png' },
    { i: 'e', x: 3, y: 2, w: 1, h: 1, embedUrl: 'https://public.tableau.com/views/Tale-of-100-Entrepreneurs_10_0_0/Taleof100Entrepreneurs?:embed=y&:loadOrderID=0&:display_count=y&:origin=viz_share_link', posterUrl: 'https://cdns.tblsft.com/sites/default/files/styles/viz_gallery_thumb/public/visualizations/vg_tale_of_100_entrepreneurs_wide_2.png?itok=zpkHheOW' },
  ]
